class Api::V1::AppointmentsController < ApplicationController # <- reflects namespace of route
    ...
    def appointment_params
        params.require(:appointment).permit(:datetime, :first_name, :last_name, :email) # strong params / "appointment" door - only allow strong params through door and into DB
    end
